...
export default function ListProducts() {
  ...
  window.onclick = function (event) {
    let matches = event.target.matches ? event.target.matches('.action-open-modal') || event.target.matches('.svg-action-open') : event.target.msMatchesSelector('.action-open-modal') || event.target.msMatchesSelector('.svg-action-open')
    if (!matches) {
      let btn = document.querySelector(".action-open-modal");
      ...
      <div className="container-product">
        <div className="search-container">
          ...
          <div className="button-area">
            <button type="submit"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#000000" strokeWidth="2" strokeLinecap="square" strokeLinejoin="arcs"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg></button>
          </div>
        </div>
        <div className="buttons">
          ...
          <a href="/" className="signup-product">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#000000" strokeWidth="2" strokeLinecap="square" strokeLinejoin="arcs"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>
            <span>Cadastrar</span>
          </a>
        </div>
        <div className="container-list-products">
          <div className="product" role="button">
            <div className="avatar-product-area">
              <img src="https://encrypted-tbn1.gstatic.com/shopping?q=tbn:ANd9GcTyfthcQYsUTn4CFZRssSUinHtrtFSXm8SInqYIqE-qF--48Qsa-X9UbUP8X8NayP7DkTKJ9hXcsKt-X6WUflAHDvkuL1R_u6OEFWvmUOA9&usqp=CAE" alt="Product Logo" />
            </div>
            <div className="product-infomation">
              <div className="title-product-area">
                <h1>Ração Golden Gatos Adultos Carne</h1>
              </div>
              <div className="description-product-area">
                <p>A Ração Golden Gatos Adultos Sabor Carne é indicada para gatos adultos. Possui um sabor irresistível para seu gatinho e vai proporcionar nutrientes no nível ideal para ele</p>
              </div>
              <div className="utilities-product-area">
                ...
                <div className="actions-product">
                  <button className="action-open-modal" onClick={(e) => openDropDown(e, 1)}>
                  ...
                  <div id="dropdown-1" className="dropdown-menu-product">
                    <ul>
                      <li role="button" onClick={() => deleteProduct(1)}>
                      ...
                      <li role="button" onClick={() => openEditModal(1)}>
                        <div className="edit-button">
                          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#000000" strokeWidth="2" strokeLinecap="square" strokeLinejoin="arcs"><path d="M20 14.66V20a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h5.34"></path><polygon points="18 2 22 6 12 16 8 16 8 12 18 2"></polygon></svg>
                          <span>Editar</span>
                        </div>
                      </li>
                    </ul>
